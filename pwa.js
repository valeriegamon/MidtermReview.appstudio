...
const cacheName = 'MidtermReview-2020-03-02 16:51:08.047336'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'MidtermReview'.length) === 'MidtermReview') {
